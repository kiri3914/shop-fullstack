...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('phone', models.CharField(blank=True, max_length=55, null=True, verbose_name='Номер телефона')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=222, verbose_name='Наименование')),
                ('slug', models.SlugField(unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('first_name', models.CharField(max_length=112, verbose_name='Имя')),
                ('last_name', models.CharField(max_length=123, verbose_name='Фамилия')),
                ('phone', models.CharField(max_length=33, verbose_name='Телефон')),
                ('address', models.CharField(blank=True, max_length=78, null=True, verbose_name='Адрес')),
                ('status', models.CharField(choices=[('new', 'новый заказ'), ('in_progress', 'заказ в обработке'), ('is_ready', 'заказ готов'), ('completed', 'заказ выполнен')], default='new', max_length=98, verbose_name='Статус')),
                ('buying_type', models.CharField(choices=[('self', 'Самовызов'), ('delivery', 'Доставка')], default='self', max_length=76, verbose_name='Тип заказа')),
